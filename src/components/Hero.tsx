...
export function Hero() {
  return (
    <div className="overflow-hidden dark:bg-[#0F172A] bg-[#002420]  dark:mt-[-4.75rem] dark:pb-32 dark:pt-[4.75rem]">
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 lg:max-w-8xl lg:grid-cols-2 lg:px-8 xl:gap-x-16 xl:px-12">
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              <p className="inline bg-gradient-to-r from-[#DFF1EF]  to-[#6FA09A] bg-clip-text font-display text-5xl tracking-tight text-transparent">
                A production-ready boilerplate app for startups and indie makers
              </p>
              <p className="mt-3 text-2xl tracking-tight text-slate-400">
                Built with React Native and Expo, the feature-packed boilerplate
                app ships with auth and data handling, push notifications,
                payments, and more.
              </p>
